...
import { TuiAppearance, TuiLink, TuiCell, TuiIcon } from '@taiga-ui/core';
...
@Component({
  ...
  imports: [TuiAppearance, TuiCell, TuiSkeleton, TuiCardLarge, TuiLink, TuiHeader, TuiSurface, TuiCell, TuiIcon],
